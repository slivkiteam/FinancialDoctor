...
export const Chart = ({color, className}: {color: string, className?: string}) => {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M10 8H8C7.44772 8 7 8.44772 7 9V16C7 16.5523 7.44772 17 8 17H10C10.5523 17 11 16.5523 11 16V9C11 8.44772 10.5523 8 10 8Z"
        stroke={color}
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
